                ...
                <form action="Controlador" method="post" enctype="multipart/form-data" >  
                    <div class="col-sm-6 ">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input class="control form-control"  type="text" placeholder="ID (Autom�tico)" maxlength="15" name="ID" readonly="" value="<%if(peli!=null && request.getAttribute("peliculaPorAgregar")==null )%><%=peli.getIdPelicula()%>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <h4 class="text-left">A�o</h4>
                            </div>
                            <div class="col-sm-9">
                                <input type="text" class="control form-control" name="anioPel" placeholder="* (A�o de lanzamiento)" pattern="^[0-9]*$" title="Numero" required value="<%if(peli!=null || request.getAttribute("peliculaPorAgregar")!=null)%><%= peli.getAnio() %>">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="text-left">Duraci�n</h4>
                            ...
                            <div class="col-sm-12">
                                ...
                                <%if(request.getAttribute("ExitoPeli")!=null){
                                   ...
                                   <div class="alert alert-success">
                                       <p class="text-center">Pelicula <%if(peli==null && request.getAttribute("peliculaPorAgregar")==null){ %>agregada<% }else{%>editada<%}%> con �xito.</p>        
                                    </div>
