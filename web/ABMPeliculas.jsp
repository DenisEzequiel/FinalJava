            ...
            <div <%if(session.getAttribute("Scroll")!=null){%> id="Edit" <%session.setAttribute("Scroll", null); }%> class="row">
                ...
                <form action="Controlador" method="post" enctype="multipart/form-data" >  
                    <div class="col-sm-6 ">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="text-left">Duraciï¿½n</h4>
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="text-left">Gï¿½neros</h4>
                            ...
                            <div class="col-sm-12">
                                ...
                                <%if(request.getAttribute("ExitoPeli")!=null){
                                   ...
                                   <div class="alert alert-success">
                                       <p class="text-center">Pelicula <%if(peli==null && request.getAttribute("peliculaPorAgregar")==null){ %>agregada<% }else{%>editada<%}%> con ï¿½xito.</p>        
                                    </div>
