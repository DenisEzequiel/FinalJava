<!DOCTYPE html>
<!-- saved from url=(0046)http://themifycloud.com/demos/templates/eshop/ -->
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="http://themifycloud.com/demos/templates/eshop/index.html" class="active">Home</a></li>
...
<a id="scrollUp" href="http://themifycloud.com/demos/templates/eshop/#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a></body></html>