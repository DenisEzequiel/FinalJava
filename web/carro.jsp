<!DOCTYPE html>
<!-- saved from url=(0055)http://themifycloud.com/demos/templates/eshop/cart.html -->
					...
					<div class="col-sm-7">
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="http://themifycloud.com/demos/templates/eshop/cart.html#">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="single-widget">
							<h2>About Shopper</h2>
							<form action="http://themifycloud.com/demos/templates/eshop/cart.html#" class="searchform">
