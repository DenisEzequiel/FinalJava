<!DOCTYPE html>
<!-- saved from url=(0055)http://themifycloud.com/demos/templates/eshop/blog.html -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <title>Blog | E-Shop</title>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="http://themifycloud.com/demos/templates/eshop/blog.html#">Shop<i class="fa fa-angle-down"></i></a>
								...
								<li class="dropdown"><a href="http://themifycloud.com/demos/templates/eshop/blog.html#" class="active">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="http://themifycloud.com/demos/templates/eshop/blog.html" class="active">Blog List</a></li>
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="http://themifycloud.com/demos/templates/eshop/blog.html#sportswear">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="http://themifycloud.com/demos/templates/eshop/blog.html#mens">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											Mens
										</a>
									</h4>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="http://themifycloud.com/demos/templates/eshop/blog.html#womens">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											Womens
										</a>
									</h4>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/blog.html#">Kids</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/blog.html#">Fashion</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/blog.html#">Households</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/blog.html#">Interiors</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/blog.html#">Clothing</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/blog.html#">Bags</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/blog.html#">Shoes</a></h4>
								</div>
							</div>
				...
				<div class="col-sm-9">
					<div class="blog-post-area">
						...
						<div class="single-blog-post">
							...
							<a href="">
								<img src="imagenes/blog-one.jpg" alt="">
							</a>
						...
						<div class="single-blog-post">
							...
							<a href="">
								<img src="imagenes/blog-two.jpg" alt="">
							</a>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
							<a class="btn btn-primary" href="">Read More</a>
						</div>
						<div class="single-blog-post">
							...
							<a href="">
								<img src="imagenes/blog-three.jpg" alt="">
							</a>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
							<a class="btn btn-primary" href="">Read More</a>
						</div>
					...
					<div class="col-sm-7">
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="http://themifycloud.com/demos/templates/eshop/blog.html#">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="single-widget">
							<h2>About Shopper</h2>
							<form action="http://themifycloud.com/demos/templates/eshop/blog.html#" class="searchform">
...
<a id="scrollUp" href="http://themifycloud.com/demos/templates/eshop/blog.html#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a></body></html>