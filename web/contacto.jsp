<!DOCTYPE html>
<!-- saved from url=(0061)http://themifycloud.com/demos/templates/eshop/contact-us.html -->
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="http://themifycloud.com/demos/templates/eshop/contact-us.html#">Shop<i class="fa fa-angle-down"></i></a>
								...
								<li class="dropdown"><a href="http://themifycloud.com/demos/templates/eshop/contact-us.html#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
								...
								<li><a href="http://themifycloud.com/demos/templates/eshop/contact-us.html" class="active">Contact</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<div class="social-networks">
							...
							<ul>
								<li>
									<a href="http://themifycloud.com/demos/templates/eshop/contact-us.html#"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="http://themifycloud.com/demos/templates/eshop/contact-us.html#"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="http://themifycloud.com/demos/templates/eshop/contact-us.html#"><i class="fa fa-google-plus"></i></a>
								</li>
								<li>
									<a href="http://themifycloud.com/demos/templates/eshop/contact-us.html#"><i class="fa fa-youtube"></i></a>
								</li>
							</ul>
	    				</div>
	    			</div>
					...
					<div class="col-sm-7">
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="http://themifycloud.com/demos/templates/eshop/contact-us.html#">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="single-widget">
							<h2>About Shopper</h2>
							<form action="http://themifycloud.com/demos/templates/eshop/contact-us.html#" class="searchform">
...
<a id="scrollUp" href="http://themifycloud.com/demos/templates/eshop/contact-us.html#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a></body></html>