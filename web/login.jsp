<!DOCTYPE html>
<!-- saved from url=(0056)http://themifycloud.com/demos/templates/eshop/login.html -->
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="http://themifycloud.com/demos/templates/eshop/login.html" class="active"><i class="fa fa-lock"></i> Login</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="http://themifycloud.com/demos/templates/eshop/login.html#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="http://themifycloud.com/demos/templates/eshop/login.html" class="active">Login</a></li> 
                                    </ul>
                                </li> 
								<li class="dropdown"><a href="http://themifycloud.com/demos/templates/eshop/login.html#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="http://themifycloud.com/demos/templates/eshop/login.html#">
					...
					<div class="col-sm-7">
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="http://themifycloud.com/demos/templates/eshop/login.html#">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="single-widget">
							<h2>About Shopper</h2>
							<form action="http://themifycloud.com/demos/templates/eshop/login.html#" class="searchform">
...
<a id="scrollUp" href="http://themifycloud.com/demos/templates/eshop/login.html#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a></body></html>
