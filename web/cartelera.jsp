...
<body>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="http://themifycloud.com/demos/templates/eshop/shop.html#" class="active">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="http://themifycloud.com/demos/templates/eshop/shop.html" class="active">Products</a></li>
								...
								<li class="dropdown"><a href="http://themifycloud.com/demos/templates/eshop/shop.html#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="http://themifycloud.com/demos/templates/eshop/shop.html#sportswear">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="http://themifycloud.com/demos/templates/eshop/shop.html#mens">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											Mens
										</a>
									</h4>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="http://themifycloud.com/demos/templates/eshop/shop.html#womens">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											Womens
										</a>
									</h4>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/shop.html#">Kids</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/shop.html#">Fashion</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/shop.html#">Households</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/shop.html#">Interiors</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/shop.html#">Clothing</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/shop.html#">Bags</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="http://themifycloud.com/demos/templates/eshop/shop.html#">Shoes</a></h4>
								</div>
							</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<a href="http://themifycloud.com/demos/templates/eshop/shop.html#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
	...
	<footer id="footer"><!--Footer-->
					...
					<div class="col-sm-7">
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="http://themifycloud.com/demos/templates/eshop/shop.html#">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="single-widget">
							<h2>About Shopper</h2>
							<form action="http://themifycloud.com/demos/templates/eshop/shop.html#" class="searchform">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2013 E-Shop. All rights reserved.</p>
...
<a id="scrollUp" href="http://themifycloud.com/demos/templates/eshop/shop.html#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a></body></html>